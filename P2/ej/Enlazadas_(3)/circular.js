...
class ListaCircular {
  ...
  imprimir() {
    ...
    let primero = actual.datos;
    //Se coloca un espacio para el simbolo
    let resultado = "";
    ...
    //cuando no exista otro nodo en la cola, se accede al primero otra vez.
...
const ListaDoble = new ListaCircular();
...
//Imprimir la lista
console.log("Lista Circular: " + ListaDoble.imprimir());
